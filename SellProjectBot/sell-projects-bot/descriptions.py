...
ABOUT = (
    ...
    + "\n————————————————"
    + "\n\n*<b><i>По всем вопросам: @менеджер</i></b>"
...
FEEDBACK = (
    "Если хотите ознакомиться с отзывами других покупателей, переходите в - <b><u>@канал</u></b>"
...
BUY_PROJECT = (
    ...
    + "\n\nЕсли захотите оставить отзыв о купленном проекте, напишите нашему менеджеру: <b><i>@менеджер</i></b>"
    + "\n\nУдачного дня 😊"
)
...
def get_project_description(project: Project) -> str:
    ...
    desc = (
        ...
        + f"\nКраткое содержание: <b>{project.summary}</b>"
        + f"\nЦена: <b><u>{project.price} ₽</u></b>"
        + f"\nКатегория: <b>{config.CATEGORIES[project.category]}</b>"
